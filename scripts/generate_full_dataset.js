...
const jobs = [
  ...
  { id: 'j2', title: 'Data Analyst', dept: 'Data Science' },
  { id: 'j3', title: 'AI/ML Engineer Intern', dept: 'AI Research' },
  { id: 'j4', title: 'Frontend Developer', dept: 'Frontend Architecture' },
  { id: 'j5', title: 'Cloud DevOps Engineer', dept: 'Infrastructure' },
  { id: 'j6', title: 'Backend Systems Engineer', dept: 'Core Platform' }
];
...
console.log(`Generated ${hieroCandidates.length} HIERO candidates and ${hieroApplications.length} HIERO applications.`);
...
console.log(`Generated ${bridgeColleges.length} colleges, ${allBridgeStudents.length} Bridge students, and ${allBridgeApps.length} Bridge applications.`);
